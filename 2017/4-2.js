...
function is_valid(passphrase) {
  ...
  let encountered_words = new Set();
  for (let word of words) {
    let sorted_letters = word.split('').sort().join('');
    if (encountered_words.has(sorted_letters)) {
      return false;
    }
    encountered_words.add(sorted_letters);
  }
  return true;
}

console.log(is_valid('abcde fghij'), 'should be true');
console.log(is_valid('abcde xyz ecdab'), 'should be false');
